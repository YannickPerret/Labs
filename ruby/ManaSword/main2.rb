...
class Player
  ...
  def initialize(window)
    @image = Gosu::Image.new(window, "images/Starfighter.bmp", false)
    @beep = Gosu::Sample.new(window, "images/Beep.wav")
...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    @star_anim = Gosu::Image::load_tiles(self, "images/Star.png", 25, 25, false)
